...
*/
    ...
    oncategoryCommand: function (list, target, index, record, evt, options) {
      ...
      /*
        ...
        localStoredetail = Ext.create('Ext.data.Store', {
            model: "CrotusValet.model.ProductDetail"
        });
        localStoredetail.load();
        var countLocalStoreProducts = localStoredetail.getCount();

        console.log("count11111111111"+countLocalStoreProducts);
