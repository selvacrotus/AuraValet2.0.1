                ...
                items:[
                    {
                        ...
                        "</div></div><div class=\"priceQuant\">" +
                        "<p>Name: <span class=\'tproquan\'>   {menu_item_name}</span><br/>Total: <span class=\'tproquan priceColr\'>&euro; {price_net} + &euro; {tax_amt} x {menu_quantity} = &euro; {total}</span><!--<br/>Price: <span class=\"pricecolor\"> &euro;{price_net}</span>--></p><div class='rembutton'><img class=\"remove\" height=35px width=25px src='resources/images/trash.png'/></div></div></div>",
